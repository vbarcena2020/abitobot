...
def generate_launch_description():
    ...
    pkg_share_folder = get_package_share_directory("abitobot")
        ...
        [
            generate_load_controller_launch_description(
                ...
                controller_params_file=join(
                    pkg_share_folder, 'config', 'abitobot_controllers.yaml'))
        ],
    )
    ...
    arm_pkg_share_folder = get_package_share_directory("abitobot_moveit_config")
